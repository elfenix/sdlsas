...
Bullet::Bullet( const Vector& p_position, bool p_evil, int p_angle, int p_parent_type ) :
	m_parent( 0 ),
...
Bullet::Bullet( const Vector& p_position, const Vector& p_velocity, bool p_type, int p_parent_type ) :
	m_parent( 0 ),
	m_parent_type( p_parent_type )
{
...
void Bullet::base_init( const Vector& p_pos, const Vector& p_velocity, bool p_evil )
{
	set_pos( p_pos );
