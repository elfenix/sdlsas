...
//    SDL_WM_SetCaption( "SDL Sasteroids", "SDL Sasteroids" );
    ...
    if( TTF_Init() < 0 )
    {
        throw std::runtime_error(
                "Couldn't initialize True type font library" );
    }
    atexit( TTF_Quit );
...
void UserInterfaceManager::ShowTextColor( int x, int y, const char *msg, char r,
        char g, char b )
{
...
SDL_Surface* UserInterfaceManager::get_text( const char* msg, char r, char g,
        char b )
{
    SDL_Surface* surface = 0;
    SDL_Color mycolor =
